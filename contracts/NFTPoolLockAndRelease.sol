...
import {IERC20} from "node_modules/@openzeppelin/contracts-5.0.2/token/ERC20/IERC20.sol";
import {SafeERC20} from "node_modules/@openzeppelin/contracts-5.0.2/token/ERC20/utils/SafeERC20.sol";
...
contract NFTPoolLockAndRelease is CCIPReceiver, OwnerIsCreator {
        ...
        ) // Make sure source chain and sender are allowlisted
    {
        ...
        address newOnwer=rd.newOnwer;
        uint256 tokenid=rd.tokenid;
        nft.transferFrom(address(this),newOnwer,tokenid);
        emit unlocked(newOnwer,tokenid);
    }
