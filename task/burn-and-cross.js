...
task("burn-and-cross")
    ...
    .setAction(async(taskArgs, hre) => {
        ...
        const wnft = await ethers.getContract("WrappedNFT", cc)
        const nftPoolBurnAndMint = await ethers.getContract("NFTPoolBurnAndMint", cc)
        ...
        // burn and cross
        const burnAndCrossTx = await nftPoolBurnAndMint.burnAndMint(tokenId, cc, chainSelector, receiver)
